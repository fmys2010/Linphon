...
wget https://raw.githubusercontent.com/fmys2010/Linphon/main/psiphon.config --quiet
wget https://raw.githubusercontent.com/fmys2010/Linphon/main/archive/psiphon.sh --quiet
...
echo "Linphon archive installation successfully completed. Run sudo ./psiphon.sh to start the program. Please allow a reasonable amount of time for Psiphon to connect as it may take a while"
